$(document).ready(function(){
    ...
    var current_theme = $.cookie('current_theme') == null ? 'slate' : $.cookie('current_theme');
    var current_lang = $.cookie('lang') == null ? 'en-US' : $.cookie('lang');
	switch_theme(current_theme);
	
	$('#themes a[data-value="' + current_theme + '"]').find('i').addClass('icon-ok');
	$('#language a[data-value="' + current_lang + '"]').find('i').addClass('icon-ok');
